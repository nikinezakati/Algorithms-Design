...
//         top = chars.find(symbol)->second + occ_count_before.find(symbol)->second[top];
//         bottom = chars.find(symbol)->second + occ_count_before.find(symbol)->second[bottom + 1] - 1;
//       } else {
//         return result;
//       }
//     } else {
...
//   map<char, int> chars = {{'$', 0}, {'A', 0}, {'C', 0}, {'G', 0}, {'T', 0}};
...
//   PreprocessBWT(bwt, chars, occ_count_before);
...
//     vector<int> occurrences = FindOccurrences(pattern, text, suffix_array, bwt, chars, occ_count_before);
